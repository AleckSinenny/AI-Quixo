...
class Server:
    ...
    def move(self):
        ...
        rdmmessage = ['Hello There', 'How you doing ?', 'Execute order 66', 'Winter is coming', 'Avengers Assemble','Alohomora',
                     'Hakuna Matata','Follow the yellow brick road', 'For the horde', 'My Precious',
                     'May the force be with you',"Frankly, my dear, I don't give a damn", "Go ahead, make my day", 
                     "Fasten your seatbelts. It's going to be a bumpy night","You talking to me?","E.T. phone home",
                     "Bond. James Bond","There's no place like home",
                     "Mama always said life was like a box of chocolates. You never know what you're gonna get",
                     "I see dead people","Hasta la vista, baby","Carpe diem","I'm king of the world!"]
        ...
        return {"move": {'cube' : int(2), 'direction' : str(direction)}, "message" : message}
